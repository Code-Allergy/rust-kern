...
pub fn read(buf: &mut [u8], mut len: u32, offset: u32) {
    ...
    while !i2c::master_int_raw_status_ex(i2c::I2C_INT_TRANSMIT_READY) {}

    i2c::master_data_put((offset & 0xFF) as u8);
    i2c::master_int_clear_ex(i2c::I2C_INT_TRANSMIT_READY);
...
pub fn init(slave: u8) {
    ...
    i2c::master_disable();
    i2c::soft_reset();
    i2c::master_init_clock(
        i2c::I2C_SYSTEM_CLOCK,
        i2c::I2C_INTERNAL_CLOCK * 2,
        i2c::I2C_OUTPUT_CLOCK,
    );
